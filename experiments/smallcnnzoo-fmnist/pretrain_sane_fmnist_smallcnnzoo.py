...
RUN_TAG = "pretraining-fmnist-v1.0"
DATA_PATH = Path(os.environ.get("SANE_DATA_DIR", "/projects/prjs2156/shared/wsl/unthi_zoo/unthi_fmnist_preprocessed/"))
EXPERIMENT_NAME = "sane_fmnist_smallcnnzoo"
WANDB_PROJECT = "sane-fmnist-smallcnnzoo"
