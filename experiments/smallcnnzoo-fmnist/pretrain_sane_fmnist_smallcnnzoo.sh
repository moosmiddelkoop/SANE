#!/bin/bash
#SBATCH --job-name=pretrain_sane_fmnist_smallcnnzoo
#SBATCH --partition=gpu_a100
#SBATCH --gpus=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18
#SBATCH --time=6:00:00
#SBATCH --output=logs/pretrain_sane_fmnist_smallcnnzoo_%j.out
...
export SANE_DATA_DIR="/projects/prjs2156/shared/wsl/unthi_zoo/unthi_fmnist_preprocessed/consolidated"

# Activate environment (adjust path if you submit from a different directory)
source "$HOME/SANE/.venv/bin/activate"

python pretrain_sane_fmnist_smallcnnzoo.py
